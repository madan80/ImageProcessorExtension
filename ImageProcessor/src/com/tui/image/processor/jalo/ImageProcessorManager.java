...
/**
 * This is the extension manager of the ImageProcessor extension.
 */
public class ImageProcessorManager extends GeneratedImageProcessorManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ImageProcessorManager.class.getName());
	...
	{
		return (ImageProcessorManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ImageProcessorConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ImageProcessorManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ImageProcessorManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ImageProcessorManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ImageProcessorManager called, current tenant: " + getTenant().getTenantID());
		}
	}
